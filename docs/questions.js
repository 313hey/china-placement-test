// ==============================
// 25题（两大题）：听力 1-15 + 第二大题 16-25
// - 听力题：把音频放在 docs/audio/ 下：L00.mp3 ~ L15.mp3
// - 图片选项：把图片放在 docs/img/ 下：L01_A.png 这种命名（见 README）
// ==============================
...
- 前8题选项是图片，请看图片选择。`,
    ...
    html: `
      <div style="border:1px solid #eee;border-radius:12px;padding:12px;background:#fafafa">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:10px">
          <div style="border:1px solid #eee;border-radius:10px;padding:10px">A. 红色（图片）</div>
          <div style="border:1px solid #eee;border-radius:10px;padding:10px">B. 蓝色（图片）</div>
          <div style="border:1px solid #eee;border-radius:10px;padding:10px">C. 绿色（图片）</div>
          <div style="border:1px solid #eee;border-radius:10px;padding:10px">D. 黄色（图片）</div>
        </div>
  ...
  // 第二大题说明页（不计分）
  {
    ...
    prompt:
`下面每题都有一个句子，句子里有一个空格“___”。请选择最合适的词，把它填进空格里。
...
提示：这部分没有音频。`,
    html: `
      <div style="border:1px solid #eee;border-radius:12px;padding:12px;background:#fafafa">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:10px">
          <div style="border:1px solid #eee;border-radius:10px;padding:10px">A. 是</div>
          <div style="border:1px solid #eee;border-radius:10px;padding:10px">B. 在</div>
          <div style="border:1px solid #eee;border-radius:10px;padding:10px">C. 有</div>
          <div style="border:1px solid #eee;border-radius:10px;padding:10px">D. 去</div>
        </div>
  ...
  { id:"C19", section:"reading", type:"mcq", points:1, prompt:"19. ___ 下雨，所以我们不去公园。 / ___ it is raining, we won’t go to the park.", choices:["A. 因为","B. 但是","C. 还是","D. 和"], answer:0 },
  { id:"C20", section:"reading", type:"mcq", points:1, prompt:"20. 你要茶 ___ 咖啡？ / Do you want tea ___ coffee?", choices:["A. 和","B. 还是","C. 因为","D. 所以"], answer:1 },
  { id:"C21", section:"reading", type:"mcq", points:1, prompt:"21. 他比我 ___ 。 / He is ___ than me.", choices:["A. 高","B. 高的","C. 高了","D. 高着"], answer:0 },
  ...
  { id:"C23", section:"reading", type:"mcq", points:1, prompt:"23. 小通知：今天下午三点有中文课，请准时到教室。\n中文课几点开始？ / What time does Chinese class start?", choices:["A. 两点","B. 三点","C. 四点","D. 五点"], answer:1 },
  { id:"C24", section:"reading", type:"mcq", points:1, prompt:"24. 他下午做什么？ / What does he do in the afternoon?", choices:["A. 做作业","B. 踢足球","C. 看电影","D. 去游泳"], answer:1 },
  { id:"C25", section:"reading", type:"mcq", points:1, prompt:"25. 我很喜欢 ___ 中文。 / I really like ___ Chinese.", choices:["A. 学习","B. 学习着","C. 学了","D. 学过"], answer:0 },
];
